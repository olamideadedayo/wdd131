...
lastModifiedDate.innerHTML = document.lastModified; // there is no need to create a new date object. The document.lastModified is already a date object.
lastModified.style.color = "white"; // this line could have been in the css file.
// .footer-txt = { color: white; } // css file
